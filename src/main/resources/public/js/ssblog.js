  ...
  return B.matches = function(a, b) {
    ...
    if(a) {
      return this.each(function(b) {
        var d = c(this), e = X(this, a, b, d.offset()), f = d.offsetParent().offset(), g = {top:e.top - f.top, left:e.left - f.left};
...
window.Zepto = Zepto, window.$ === undefined && (window.$ = Zepto), function(a) {
  ...
  }, h = {}, i = {}, j = "onfocusin" in window, k = {focus:"focusin", blur:"focusout"}, l = {mouseenter:"mouseover", mouseleave:"mouseout"};
  i.click = i.mousedown = i.mouseup = i.mousemove = "MouseEvents", a.event = {add:s, remove:t}, a.proxy = function(b, c) {
    if(f(b)) {
      var d = function() {
  ...
  var u = function() {
    ...
    return!1
  }, w = /^([A-Z]|returnValue$|layer[XY]$)/, x = {preventDefault:"isDefaultPrevented", stopImmediatePropagation:"isImmediatePropagationStopped", stopPropagation:"isPropagationStopped"};
  a.fn.delegate = function(a, b, c) {
    ...
    return i === !1 && (i = v), m.each(function(d, f) {
      j && (k = function(a) {
        ...
        if(g && g !== f) {
          return d = a.extend(z(b), {currentTarget:g, liveFired:f}), (k || i).apply(g, [d].concat(e.call(arguments, 1)))
        }
      }), s(f, b, i, h, c, l || k)
    })
  ...
  h.extend(I.prototype, o, {interval:50, getHash:function(t) {
    ...
    if(this._wantsHashChange && this._wantsPushState) {
      if(!this._hasPushState && !n) {
        ...
        if(this._hasPushState && n && s.hash) {
...
ssblog.routers.App = Backbone.Router.extend({routes:{"post/:id":"post", "*all":"default"}});
goog.provide("ssblog.models.Posts");
goog.require("backbone");
ssblog.models.Posts = Backbone.Model.extend({defaults:function() {
  return{title:"", date:""}
}});
goog.provide("ssblog.collections.Posts");
goog.require("backbone");
goog.require("ssblog.models.Posts");
ssblog.collections.Posts = Backbone.Collection.extend({model:ssblog.models.Posts, initialize:function(posts) {
  this.collection = posts
}});
goog.provide("ssblog.views.Post");
goog.require("backbone");
ssblog.views.Post = Backbone.View.extend({tagName:"div", className:"post", initialize:function(options) {
...
goog.require("backbone");
ssblog.views.PostLink = Backbone.View.extend({initialize:function(options) {
  console.log("post link", this.model)
}, render:function() {
  var link = "#/post/" + this.model.get("id");
  this.$el.html("<a href='" + link + "'>" + this.model.get("title") + "</a>");
  return this
}});
goog.provide("ssblog.views.Posts");
goog.require("backbone");
goog.require("ssblog.views.PostLink");
ssblog.views.Posts = Backbone.View.extend({tagName:"div", className:"posts", initialize:function(options) {
...
ssblog.views.App = Backbone.View.extend({el:"#app", initialize:function(options) {
...
$(document).ready(function() {
  var posts = new ssblog.collections.Posts([{"id":"dct", "title":"Discrete Cosine Transform", "date":"2014-01-18", "template":"#template-post-dct"}, {"id":"fft", "title":"Fast Fourier Transform", "date":"2014-02-18", "template":"#template-post-fft"}]);
  var app_view = new ssblog.views.App({posts:posts});
...
goog.provide("ssblog.core");
goog.require("cljs.core");
goog.require("ssblog.App");
